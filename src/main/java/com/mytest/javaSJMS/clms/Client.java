 ...
 * 
 * 总结：
 * 该设计模式可应用在:一个入口，根据不同条件实现不同算法的模式
 * @author cyz
 *
 */
public class Client {
	 ...
	 public static void main(String[] args) {
	        ...
	        Price price2 = new Price(primary); 
	        double quote2 = price2.quote(300);
	        System.out.println("图书的最终价格为：" + quote2);
	        
	        
	        MemberStrategy Intermediate =new IntermediateMemberStrategy();
	        Price price3 = new Price( Intermediate); 
